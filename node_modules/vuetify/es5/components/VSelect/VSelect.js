...
exports.default = {
    ...
    mixins: [fakeVMenu, fakeMenuable, _comparable2.default, _filterable2.default],
    props: {
        appendIcon: {
            type: String,
    ...
    methods: {
            ...
            return this.$createElement(_VMenu2.default, {
                ...
                on: {
                    input: function input(val) {
                        _this5.isMenuActive = val;
                        _this5.isFocused = val;
                    }
                },
                ref: 'menu'
        ...
        onMouseUp: function onMouseUp(e) {
            ...
            if (this.isMenuActive && appendInner && (appendInner === e.target || appendInner.contains(e.target))) {
                this.$nextTick(function () {
                    return _this6.isMenuActive = !_this6.isMenuActive;
                });
        ...
        setSelectedItems: function setSelectedItems() {
            ...
            var _loop = function _loop(value) {
                var index = _this9.allItems.findIndex(function (v) {
                    return _this9.valueComparator(_this9.getValue(v), _this9.getValue(value));
                });
                if (index > -1) {
                    selectedItems.push(_this9.allItems[index]);
                }
            };
